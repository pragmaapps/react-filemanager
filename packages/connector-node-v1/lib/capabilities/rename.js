            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.prev = 1;
                  _context.next = 4;
                  return _inscopixApi2.default.getChildrenForId(apiOptions, { id: selectedResources[0].path, sortBy: null, sortDirection: null, where: apiOptions.fromWhere });
                ...
                case 10:
                  hideDialog();
                  _context.next = 13;
                  return _inscopixApi2.default.renameResource(apiOptions, selectedResources[0].path, name, selectedResources[0].name);
