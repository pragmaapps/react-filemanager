...
exports.default = {
  ...
  rename: "<svg class=\"MuiSvgIcon-root jss79\" focusable=\"false\" viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34a.9959.9959 0 00-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z\"></path></svg>",
  ...
  warning: "",
  copy: "<svg id=\"Layer_35\" data-name=\"Icon Copy\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 23.32 23.32\"><title>Copy File(s)</title><path d=\"M25.41,8.76H23.24V6.59A2.25,2.25,0,0,0,21,4.34H6.59A2.25,2.25,0,0,0,4.34,6.59V21a2.25,2.25,0,0,0,2.25,2.25H8.76v2.17A2.25,2.25,0,0,0,11,27.66h14.4a2.25,2.25,0,0,0,2.25-2.25V11A2.25,2.25,0,0,0,25.41,8.76ZM8.76,11V21.24H6.59A.25.25,0,0,1,6.34,21V6.59a.25.25,0,0,1,.25-.25H21a.25.25,0,0,1,.25.25V8.76H11A2.25,2.25,0,0,0,8.76,11Zm16.9,14.4a.25.25,0,0,1-.25.25H11a.25.25,0,0,1-.25-.25V11a.25.25,0,0,1,.25-.25h14.4a.25.25,0,0,1,.25.25Z\" transform=\"translate(-4.34 -4.34)\"></path></svg>",

  miraFileIcon: "<svg class=\"MuiSvgIcon-root jss67\" focusable=\"false\" viewBox=\"0 0 24 24\" aria-hidden=\"true\" tabindex=\"-1\" title=\"LibraryBooks\" data-ga-event-category=\"material-icons\" data-ga-event-action=\"click\" data-ga-event-label=\"LibraryBooks\"><path d=\"M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-1 9H9V9h10v2zm-4 4H9v-2h6v2zm4-8H9V5h10v2z\"></path></svg>",

  gpio: "<svg class=\"MuiSvgIcon-root jss67\" focusable=\"false\" viewBox=\"0 0 24 24\" aria-hidden=\"true\" tabindex=\"-1\" title=\"SwapCalls\" data-ga-event-category=\"material-icons\" data-ga-event-action=\"click\" data-ga-event-label=\"SwapCalls\"><path d=\"M18 4l-4 4h3v7c0 1.1-.9 2-2 2s-2-.9-2-2V8c0-2.21-1.79-4-4-4S5 5.79 5 8v7H2l4 4 4-4H7V8c0-1.1.9-2 2-2s2 .9 2 2v7c0 2.21 1.79 4 4 4s4-1.79 4-4V8h3l-4-4z\"></path></svg>",

  isxd: "<svg class=\"MuiSvgIcon-root jss67\" focusable=\"false\" viewBox=\"0 0 24 24\" aria-hidden=\"true\" tabindex=\"-1\" title=\"FilterDrama\" data-ga-event-category=\"material-icons\" data-ga-event-action=\"click\" data-ga-event-label=\"FilterDrama\"><path d=\"M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.61 5.64 5.36 8.04 2.35 8.36 0 10.9 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM19 18H6c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4h2c0-2.76-1.86-5.08-4.4-5.78C8.61 6.88 10.2 6 12 6c3.03 0 5.5 2.47 5.5 5.5v.5H19c1.65 0 3 1.35 3 3s-1.35 3-3 3z\"></path></svg>",

  folderIcon: "<svg class=\"MuiSvgIcon-root jss67\" focusable=\"false\" viewBox=\"0 0 24 24\" aria-hidden=\"true\" tabindex=\"-1\" title=\"Folder\" data-ga-event-category=\"material-icons\" data-ga-event-action=\"click\" data-ga-event-label=\"Folder\"><path d=\"M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z\"></path></svg>",
